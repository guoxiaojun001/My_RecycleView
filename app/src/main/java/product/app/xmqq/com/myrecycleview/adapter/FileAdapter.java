...
public class FileAdapter extends TreeAdapter<File> {
    ...
    @Override
    public void onBindViewHolder(BaseViewHolder holder, TreeNode<File> node,
                                 File file, int viewType, int position) {
        View itemView = holder.itemView;
        itemView.setPadding(PADDING * node.level, itemView.getPaddingTop(),
